...
from typing import (Union, Optional,
                    Mapping, Iterator, SupportsFloat)
...
class AbsoluteCoordinate(Coordinate):
    ...
    def infiltrate(self, target:ctypes.Structure,
...
class CartesianCoordinateSystem(Coordinate):
    ...
    def __init__(self, x, y, z, r=0.0) -> 'CartesianCoordinateSystem':
        if type(self) is CartesianCoordinateSystem:
            raise TypeError("You can't create an instance of `CoordinateSystem` class.")
...
class CartCoord(CartesianCoordinateSystem, AbsoluteCoordinate):
    ...
    def __init__(self, x:SupportsFloat, y:SupportsFloat,
                       z:SupportsFloat, r:SupportsFloat=0.0, check:bool=False):
...
# methods
def convert_coord(point: Mapping[str, SupportsFloat], relative: bool) -> Coordinate:
